...
* Hebbeker's Comments
** DONE Shorten gauge symmetry etc.
** DONE feynman graphs for neutrinoless double beta-decays and RPV pion
** DONE sigma and br dependence on lambda in signature chapter
** DONE fix cut arrow in histograms
** DONE remove / 1 from histograms
** DONE JER dependence on eta and pt
** DONE "cutflow" <-> table
** DONE rephrase tl ratio stuff
** DONE atlas analysis?
** DONE rephrase bullet cluster "overlay .."
** DONE ATLAS search in "current limits"
** DONE pion limit units!
** DONE stable LSP in signature
** DONE fix phrase of motivation for parameters
** DONE fix QCD p_T
** DONE candidate event errors
** DONE matched histogram
** DONE cls method
