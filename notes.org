...
** TODO round values in tables
* Daniel Notes
** page 1
*** Aronyms: Standard model -> SM
*** Fermion: Matter; Boson: Interaction
*** 3 interactions in SM: EW, weak + strong
*** DONE electrons interact with anything *that carries a charge*
** page 2
*** DONE +- sign
*** DONE strong force between quarks -> hadrons
**** 
*** TODO 3 forces part of the SM?
** page 3
...
** page 8 
*** observation in the 1940 by "zwicky"
*** complete the energy content 25% DM, 70% DE (ref. planck measurement)
** page 9
...
** page 14
*** either LNV and BNV coupling can be !=0 but not both
** page 16
*** add lambda prime 211 on z axis in 2011 plot
