...
** TODO fix values in SR1-6 table
** TODO show signal distribution in m_smu_chi.pdf
** TODO add smuon and gaugino mass in candidate events
** TODO mention smuon & gaugino mass calculation earlier
