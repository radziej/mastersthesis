...
\usepackage{dcolumn} % column alignment for decimal numbers
...
\usepackage[backend=biber,
	...
	url=true, 
	doi=true,
	eprint=true]{biblatex} % use biblatex with biber
\renewbibmacro{in:}{,}
...
\hypersetup{plainpages=false,
  ...
  linktoc=none,               %only the page numbers are colored in the table of contents
