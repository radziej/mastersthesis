...
\item $\mathbf{H / E < 0.12 (0.10)}$ - Ratio of energy measurement in HCAL to ECAL. Electrons are expected to deposit most of their energy in the ECAL, hence this ratio is expected to be low. 
...
Isolation describes the amount of energy in close vicinity $\Delta R = 0.3$ to the particle's trajectory. To match the electron trigger's settings, the individual tracker and calorimeter entries are also required to have an isolation less than 0.2, respectively.
