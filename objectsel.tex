...
\begin{figure}[ht!]
  ...
  \caption{Each bin represents the number of data events passing the various trigger combinations given on the $x$-axis. All four runs of 2012~\ref{tab:data} are included in this distribution.}
  \label{fig:matched}
\end{figure}
