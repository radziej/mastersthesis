...
\footnotetext{$\hat{p}_{\text{T}}$ refers to the sum of all transverse momenta of an interaction.} 
\footnotetext{\textsc{Pythia6} does not include $W$ and $Z$ bosons in the showering process, which is why additional $t\bar{t} + V$ samples are required.} 
...
\footenotetext{In the $m_0 = 1000\,\text{GeV}$, $m_0 = 1200\,\text{GeV}$ case, the smuon and sneutrino mass coincide at $m_{\tilde{\nu}} \approx m_{\tilde{\mu}} = 1272\,\text{GeV}$.
