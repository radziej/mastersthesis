...
\hline
$t\bar{t}$ \footnotemark & $234^{+10}_{-9}$ $\star$$\star$$\star$ & 0.212 \\
\hline
...
\footnotetext[4]{\textsc{Pythia6} does not include $W$ and $Z$ bosons in the showering process, which is why additional $t\bar{t} + V$ samples are required.} 
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}[b]{0.495\textwidth}
    ...
    \caption{Transverse momentum of leading muon, $p_{\text{T}, 1\text{st} \mu} > 10\,\text{GeV}$. Structures correspond to the smuon and sneutrino masses\footnotemark.\label{fig:sig_muo_pt1}}
  \end{subfigure}
\end{figure}
...
\noindent Determining the width of this distribution yields the energy resolution. The entire distribution cannot be accurately modeled with a Gaussian function, however the width of the peak is reasonably well described. It yields $\sigma_{\text{MC}} = 6.2\,\text{GeV}$ a negligible statistical error. While this distribution does depend on the transverse momentum and $\eta$ of the jet, the resolution of the majority of jets (more than $95\,\pct$) is well described by this value. Variations of $\sigma_{\text{MC}}$ have shown an impact of less than $1\,\pct$ on the final distribution. The $p_{\text{T}}$ and $\eta$ dependence, as well the systematic uncertainty of the fit due to the shape are taken into account in the dedicated systematics section (Sec.~\ref{sec:jersys}).
