...
\begin{table}[h!]
  ...
  \end{tabular}
  \caption{Overview of the data recorded by the CMS experiment\footnote{The DoubleMuParked dataset from the 2012A period is not a superset of the DoubleMu dataset. As such, the DoubleMu dataset is being used, which yields an additional $\sim 3\,\pct$ events in the chosen final state.}, which is going to be used in this analysis. During the 2012 data taking period, the center-of-mass energy was set to $\sqrt{s} = 8\,\text{TeV}$.}
  \label{tab:data}
\end{table}
