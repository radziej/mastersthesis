...
\documentclass[12pt,a4paper,twoside,openright]{scrbook} % style of the document, fontsize, pagesize and spacing (incl. binding space)
...
\begin{titlepage}
  ...
  \begin{center}
    ...
    % Title
    \doublespacing
    \textsc{\LARGE \textbf{Search for Resonant Slepton Production in a DiMuon + Jets Final State with 2012 CMS Data}}\\[1.5cm]
    \singlespacing
