...
For the background Monte Carlos, the overall effect for an upward deviation then amounts to $-0.1\,\pct$ while for the downward one it is $+0.6\,\pct$. For the signal prediction, it varies between $1.2\,\pct$ and $3.4\,\pct$.
...
The effect on the final distribution is $-0.6\,\pct$ for the upward variation and $+0.2\,\pct$ for the downward one. Its impact on the signal lies between $0.2\,\pct$ and $1.4\,\pct$. 
...
Due to the nature of this analysis, implementing scale factors for muons depending on their transverse momentum can lead to moderately complex individual event weights. To avoid this issue, keeping the transverse momentum threshold of $15\,\text{GeV}$ for the sub-leading muon in mind, a conservative $5\,\pct$ systematic uncertainty is assumed as compensation.
...
\begin{table}[!htb]
  ...
  \begin{tabular}{|l|c|}
    ...
    \hline
    \hline
    Data-driven Background Estimate & 47.0            \\
    \hline
